...
Также менялось количество процессов: 1, 2, 4, 8. Для каждого размера матрицы и каждого количества процессов измерялось время выполнения умножения. Результаты представлены в директории `results`, а также визуализированы на графике зависисмости времени выполнения от размера графика:
